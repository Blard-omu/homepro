...
//           key={_id}
//         >
//           <div className="min-h-[396px] p-2 2xl:p-6 rounded-2xl min-w-[355px]">
//            <div className="">
//            <img src={image} alt="" className="w-full h-[245px] rounded-xl" />
//            </div>
//             <div className="flex text-[#1F1F1F] justify-between pt-2 pr-2">
//               <div className="flex">
...
const PropertyCard = ({
  ...
  return (
    <>
      <Link to={`/detail/${_id}`}>
        <div
          className="rounded-2xl border border-slate-300 w-[355px] 2xl:w-[400px] text-dark hover:shadow-lg shadow-primary-foreground hover:border-primary"
          key={_id}
        >
          <div className="min-h-[396px] p-2 2xl:p-6 rounded-2xl min-w-[355px]">
            ...
            <div className="w-full justify-between flex text-[#1F1F1F]">
              ...
              <div className="w-[25%] text-[#1F1F1F] flex items-center">
                <div className="w-[50%]">
                  <img src={bathIcon} alt="bath" className="" />
                </div>
                <span className="w-[50%] text-sm">{bath} bed</span>
              </div>
              ...
              <div className="w-[35%] text-[#1F1F1F] flex items-center">
                <div className="w-[30%]">
                  <img src={tdesign} alt="size" className="" />
                </div>
                <span className="w-[70%] text-sm">{size} sq ft</span>
              </div>
            </div>
