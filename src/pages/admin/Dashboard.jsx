...
const Dashboard = () => {
  return (
    <div className=" mt-16 lg:min-w-[1175px] min-h-[100vh]">
      {/* Dashboard Title */}
      <div className='w-full flex justify-start items-center py-6 bg-white'>
      ...
      <div className="mt-16 bg-[#FFFEF9] p-6 flex items-center space-x-6 ">
        <div className="w-[609px] h-[279px] flex items-center space-x-6">
          {/* Text Section */}
          <div className="w-1/2">
            <h2 className="text-2xl font-bold mb-4">Welcome Maryam Moyo</h2>
            <p className="text-gray-700 font-[Avenir LT Std] text-lg leading-6">
              Manage your property searches, saved listings, and more from your personalized dashboard.
              Whether you're actively looking to buy or just browsing, we’ve got everything you need to stay organized and make informed decisions.
            </p>
          </div>
  ...
  <div className="flex justify-between items-center mb-4 w-[600px]">
    <h1 className="text-[#1F1F1F] text-[28px] font-[Avenir LT Std]">Recent Activities</h1>
  </div>
...
<div className=' mt-5 p-2 flex items-start space-x-4'>
 ...
 <h2 className='font-[Avenir LT Std] text-[18px] leading-[21.6px] '>You recently added a property to your favorites.</h2>
...
<div className='mt-7 w-full min-h-full flex justify-start items-center'>
        <div className='font-[Avenir LT Std] text-[#1F1F1FD9]'>
            <h2 className='text[24px] text-[#000000] font-[Avenir LT Std] w-[700px]'>properties purchased so far</h2>
            <p className='text-[18px] w-[600px]'>here are the properties you have purchased,review them so far</p>
        </div>
    </div>
  ...
  <div className="flex flex-row justify-between items-start w-full h-[107px] mt-4 p-4 bg-white shadow-md rounded-md">
    <div className="flex flex-row gap-4">
      <img src={image2} alt="Standard Bungalow" className="w-[94px] h-[75px] rounded-md" />
      <div className="flex flex-col justify-between">
        <h2 className="text-[18px] text-[#000000] font-[Avenir LT Std]">Standard Bungalow</h2>
        <p className="text-[#000000] text-[16px] leading-[19.2px]">No 3, Jaja Crescent, Gwarimpa, Abuja.</p>
        <span className="text-[14px] font-[Avenir LT Std] text-[#9DA008] leading-[16.8px]">₦95,000,000</span>
      </div>
    </div>

    <div className="flex flex-row gap-2.5 justify-between text-right">
  <span className="text-[#000000] text-[16px] leading-[19.2px]">31st July, 2024</span>
  ...
  <div className="flex flex-row gap-4">
    <img src={image3} alt="Hotel" className="w-[94px] h-[75px] rounded-md" />
    <div className="flex flex-col justify-between">
